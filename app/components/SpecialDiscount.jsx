    ...
    <section className='py-10'>
        <div className='flex w-7/12 m-auto gap-x-10 md:flex-col md:w-full'>
            ...
            <div className='w-6/12 px-3 md:w-full md:flex md:flex-col md:justify-center md:items-center'>
                ...
                <p className='md:text-sm text-center'>Dive into a world of saving with iur exclusive discounts! indulge in your favorite dishes while enjoying special offers crafted just for you. From tantalizing combo deals to limited-time promotion. Ouer discounts we designed to make your dining experience more delightful.Explore and savor the flavor without breaking the bank!</p>
