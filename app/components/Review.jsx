...
const Review = () => {
    ...
    return (
    <section >
        <div className='max-w-5xl m-auto py-10  overflow-hidden'> 
            <Slider {...settings}>
                <div className='w-full'>
                    <p className='text-center italic lg:text-sm'>The pizza here are a masterpiece! Each slice is a burst of authentic italian flavours, from the Perfectly thi crust to the rich tomato sauce and premium toppings. A true homage to the art of Neapolitan pizza-making</p>
                    <div className='flex items-center gap-x-2 justify-center mt-5'>
                        ...
                        <span className='lg:text-sm'>Shamika Smith</span>
                    </div>
                </div>
